...
import ContactTextareaField from "@/features/contact/form/ContactTextareaField";
import ContactSubmitButton from "@/features/contact/form/ContactSubmitButton";


export default function ContactForm() {
    return (
        <div className="w-full max-w-[682px] min-h-[576px] h-auto bg-[#FFFFFF] border border-[#C3C6D5] rounded-lg flex items-center justify-center">
